...
//You can also find definitions about SD card pins but this values better don't touch only SDCARDDETECT value you can change without any problem
      ...
      #define LCD_PINS_D7 29
        ...
        #define BEEPER -1  // 37 = enabled; -1 = dissabled / (if you don't like the beep sound ;-)

        #define BTN_EN1 33 //was 31 //entcoder turn direction is now right .from sainsmart lcd (big one )green light.
        #define BTN_EN2 31 //was 33
        #define BTN_ENC 35
        ...
        #define BEEPER -1 //was on=33 off=-1// Beeper on AUX-4
      ...
      #define BEEPER -1 //was 33		//No Beeper added
